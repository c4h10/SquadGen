...
export class XwingTranslationService {
  private dictionary: { type: string, value: string }[] = [
    ...
    {type: '%HULL%', value: `<i class="xwing-miniatures-font xwing-miniatures-font-hull color-hull"></i>`},
    {type: '%SHIELD%', value: `<i class="xwing-miniatures-font xwing-miniatures-font-shield color-shield"></i>`},
    ...
    {type: '%ROTATEARC%', value: `<i class="xwing-miniatures-font xwing-miniatures-font-rotatearc"></i>`},
    ...
    {type: '%SLAM%', value: `<i class="xwing-miniatures-font xwing-miniatures-font-slam"></i>`},
